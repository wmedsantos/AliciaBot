...
The `AlicIA_API_Collection.postman_collection.json` file contains all API endpoints for testing the AlicIA booking system, now including **Day 6 JWT Authentication**.
...
4. Choose `AlicIA_API_Collection.postman_collection.json`
5. Click **Import**
...
3. Check API logs: `dotnet run --project src/AlicIA.Api`
